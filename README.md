i wanted to explore and learn more about discord and bots, so using the discord.js docs i created a simple bot using node, cron and discord.js that can send scheduled messages in a discord server.
